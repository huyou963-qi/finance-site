  ...
  return (
    <>
      ...
      {open ? (
        ...
        >
          <div
            className="max-h-[90vh] w-full max-w-md overflow-y-auto rounded-lg border border-fs-border bg-fs-bg p-4 shadow-xl"
          ...
          >
            ...
            {previews.length > 0 ? (
              <div className="mb-3 flex flex-wrap gap-2">
                {previews.map((url, i) => (
                  <div key={url} className="relative h-16 w-16 overflow-hidden rounded border border-fs-border">
