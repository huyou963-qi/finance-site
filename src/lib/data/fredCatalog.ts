...
const FRED_US_ITEMS: readonly FredDef[] = [
  ...
  { id: "CUSR0000SETG01", label: "CPI 机票", category: "CPI 分项", frequency: "月" },
  { id: "CUSR0000SEHB", label: "CPI 外宿（酒店等）", category: "CPI 分项", frequency: "月" },
  { id: "CUUR0000SETB01", label: "CPI 汽油（全部类型，未季调）", category: "CPI 分项", frequency: "月" },
  { id: "CPILFENS", label: "核心 CPI（未季调）", category: "CPI 综合", frequency: "月" },
  ...
  { id: "WPSFD49116", label: "PPI 核心最终需求（季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIDGS", label: "PPI 最终需求商品（季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIDFS", label: "PPI 最终需求食品（季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIDES", label: "PPI 最终需求能源（季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "WPSFD413", label: "PPI 商品除食品能源（季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIDSS", label: "PPI 最终需求服务（季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPITSS", label: "PPI 贸易服务（季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIAWS", label: "PPI 运输与仓储服务（季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPITWS", label: "PPI 其他服务（季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIFID", label: "PPI 最终需求（非季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "WPUFD49116", label: "PPI 核心最终需求（非季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIFDG", label: "PPI 最终需求商品（非季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIFDF", label: "PPI 最终需求食品（非季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIFDE", label: "PPI 最终需求能源（非季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "WPUFD413", label: "PPI 商品除食品能源（非季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIFDS", label: "PPI 最终需求服务（非季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPIDTS", label: "PPI 贸易服务（非季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPITAW", label: "PPI 运输与仓储服务（非季调）", category: "通胀驱动因子", frequency: "月" },
  { id: "PPITTW", label: "PPI 其他服务（非季调）", category: "通胀驱动因子", frequency: "月" },
  ...
  { id: "GASREGW", label: "美国普通汽油零售均价（周度）", category: "通胀驱动因子", frequency: "周" },
  { id: "DHHNGSP", label: "亨利港天然气现货价格", category: "通胀驱动因子", frequency: "日" },
  { id: "DJFUELUSGULF", label: "航空煤油现货价格（美国墨西哥湾）", category: "通胀驱动因子", frequency: "日" },
  ...
  { id: "RPONTTLD", label: "SRF 使用量（隔夜回购接受量总计，十亿美元）", category: "银行与货币", frequency: "日" },
  { id: "RPONTSYD", label: "SRF 使用量：美国国债抵押品（十亿美元）", category: "银行与货币", frequency: "日" },
  { id: "RPONAGYD", label: "SRF 使用量：机构债抵押品（十亿美元）", category: "银行与货币", frequency: "日" },
  { id: "RPONMBSD", label: "SRF 使用量：机构 MBS 抵押品（十亿美元）", category: "银行与货币", frequency: "日" },
  { id: "RPONTSYSAD", label: "SRF 提交量：美国国债抵押品（十亿美元）", category: "银行与货币", frequency: "日" },
  ...
  { id: "IEABCS", label: "服务差额（百万美元）", category: "对外贸易与汇率", frequency: "季度" },
  { id: "IEABCPI", label: "初次收入差额（百万美元）", category: "对外贸易与汇率", frequency: "季度" },
  { id: "IEABCSI", label: "二次收入差额（百万美元）", category: "对外贸易与汇率", frequency: "季度" },
  { id: "IEAA", label: "美国取得对外金融资产（不含衍生品）", category: "对外贸易与汇率", frequency: "季度" },
  { id: "IEAI", label: "美国发生对外金融负债（不含衍生品）", category: "对外贸易与汇率", frequency: "季度" },
  { id: "IEANLF", label: "金融账户净借贷（百万美元）", category: "对外贸易与汇率", frequency: "季度" },
  { id: "IEAIDI", label: "直接投资负债流量（百万美元）", category: "对外贸易与汇率", frequency: "季度" },
  { id: "IEAIPI", label: "证券投资负债流量（百万美元）", category: "对外贸易与汇率", frequency: "季度" },
  { id: "IEAIOI", label: "其他投资负债流量（百万美元）", category: "对外贸易与汇率", frequency: "季度" },
  ...
  { id: "RSFSXMV", label: "零售销售总额（不含机动车与零部件，百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "MARTSSM44Z72USS", label: "零售销售总额（不含加油站，百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "MARTSSM44W72USS", label: "零售销售总额（不含机动车与零部件、加油站，百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSMVPD", label: "零售销售：机动车与零部件经销商（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSAOMV", label: "零售销售：汽车及其他机动车经销商（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSFHFS", label: "零售销售：家具与家居用品店（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSEAS", label: "零售销售：电子电器店（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSBMGESD", label: "零售销售：建材园艺用品店（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSDBS", label: "零售销售：食品与饮料店（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSGCS", label: "零售销售：食品杂货店（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSHPCS", label: "零售销售：健康与个人护理店（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSGASS", label: "零售销售：加油站（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSCCAS", label: "零售销售：服装及饰品店（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSSGHBMS", label: "零售销售：运动用品、爱好、乐器及书店（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSGMS", label: "零售销售：综合商品店（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSMSR", label: "零售销售：其他杂项零售店（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSNSR", label: "零售销售：无店铺零售商（百万美元）", category: "国内贸易与消费", frequency: "月" },
  { id: "RSFSDP", label: "零售销售：餐饮服务与饮品场所（百万美元）", category: "国内贸易与消费", frequency: "月" },
  ...
  { id: "FRGSHPUSM649NCIS", label: "Cass 货运指数：运量", category: "物流与出行", frequency: "月" },
  { id: "FRGEXPUSM649NCIS", label: "Cass 货运指数：运费支出", category: "物流与出行", frequency: "月" },
  { id: "RAILFRTCARLOADSD11", label: "铁路货运车皮数（季调，BTS）", category: "物流与出行", frequency: "月" },
  { id: "RAILFRTINTERMODALD11", label: "铁路联运箱量（季调，BTS）", category: "物流与出行", frequency: "月" },
