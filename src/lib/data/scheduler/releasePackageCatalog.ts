...
export const RELEASE_PACKAGE_CATALOG: readonly ReleasePackageDef[] = [
  ...
  probePkg("jp.esri.consumer_confidence", "日本消费者信心调查", {
    countryCode: "JP", agencyId: "jp-esri", granularity: "MONTHLY", intervalHours: 24,
    members: { instrumentCodes: JP_ESRI_CONSUMER_CONFIDENCE_SERIES.map((series) => series.instrumentCode) },
  }),
  probePkg(JP_BOJ_BOP_PACKAGE_ID, "日本国际收支", {
  ...
  probePkg("cn.safe.external", "中国外汇与国际收支", {
    ...
    intervalHours: 24,
    sortOrder: 251,
    members: { instrumentCodePatterns: ["safe_cn_reserve_*", "safe_cn_settlement_*", "safe_cn_payments_*"] },
  }),
  probePkg("cn.safe.bop-quarterly", "中国国际收支平衡表", {
    labelEn: "SAFE Balance of Payments",
    countryCode: "CN",
    agencyId: "cn-safe",
    granularity: "QUARTERLY",
    intervalHours: 168,
    sortOrder: 252,
    members: { instrumentCodePatterns: ["safe_cn_bop_*"] },
  }),
  probePkg("cn.safe.iip-quarterly", "中国国际投资头寸表", {
    labelEn: "SAFE International Investment Position",
    countryCode: "CN",
    agencyId: "cn-safe",
    granularity: "QUARTERLY",
    intervalHours: 168,
    sortOrder: 253,
    members: { instrumentCodePatterns: ["safe_cn_iip_*"] },
  }),
  probePkg("cn.safe.external-debt-quarterly", "中国全口径外债", {
    labelEn: "SAFE External Debt",
    countryCode: "CN",
    agencyId: "cn-safe",
    granularity: "QUARTERLY",
    intervalHours: 168,
