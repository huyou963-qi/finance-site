...
export const SEED_CATALOG_REGISTRY: Record<string, SeedCatalogEntry> = {
  ...
  "gold-prices": { script: "seed-gold-prices", labelZh: "黄金现货（WGC LBMA）/ COMEX 期货（GC=F）标准序列" },
...
export const VERIFY_CATALOG_REGISTRY: Record<string, SeedCatalogEntry> = {
  ...
  "gold-prices": { script: "verify-gold-prices", labelZh: "黄金现货/期货标准序列自检", verifyNeedsDb: true },
