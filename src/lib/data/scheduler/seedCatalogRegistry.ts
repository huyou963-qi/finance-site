...
export const SEED_CATALOG_REGISTRY: Record<string, SeedCatalogEntry> = {
  ...
  "nfra-banking": { script: "seed-nfra-banking", labelZh: "中国金融监管总局银行业监管统计" },
  "safe-external": { script: "seed-safe-external", labelZh: "中国外汇与国际收支" },
  "mofcom-trade": { script: "seed-mofcom-trade", labelZh: "中国外贸与外部部门" },
  "gacc-commodity": { script: "seed-gacc-commodity", labelZh: "中国海关主要商品量值（抓取）" },
...
export const VERIFY_CATALOG_REGISTRY: Record<string, SeedCatalogEntry> = {
  ...
  "multpl-sp500-pe": { script: "verify-multpl-sp500-pe", labelZh: "标普500 市盈率自检", verifyNeedsDb: true },
  "retired-indicators": { script: "verify-retired-indicators", labelZh: "退役指标与模板替换自检", verifyNeedsDb: true },
  "yahoo-gold-prices": { script: "verify-yahoo-gold-prices", labelZh: "黄金收盘价（行情接口）自检", verifyNeedsDb: true },
  ...
  "nfra-banking": { script: "verify-nfra-banking", labelZh: "中国金融监管总局银行业监管统计自检", verifyNeedsDb: true },
  ...
  "gacc-commodity": { script: "verify-gacc-commodity", labelZh: "中国海关主要商品量值自检", verifyNeedsDb: true },
