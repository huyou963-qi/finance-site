...
export function isChinaOfficialUrl(input: string | URL): boolean {
  ...
  return CHINA_OFFICIAL_HOSTS.has(hostname) || hostname.endsWith(".stats.gov.cn") || hostname.endsWith(".pbc.gov.cn") || hostname.endsWith(".safe.gov.cn") || hostname.endsWith(".mofcom.gov.cn") || hostname.endsWith(".nfra.gov.cn");
}
