...
export const CPI_FRED_SERIES: readonly CpiFredSeedRow[] = [
  ...
  // —— CPI 分项环比表（BLS Table A）所需分项（2026-07-14 FRED 校验，最新 obs 2026-06） ——
  cpiFredRow("CPIUFDSL", "CPI 食品", "CPI 分项", "月", "MONTHLY", "指数"),
  cpiFredRow("CUSR0000SAF11", "CPI 家庭食品", "CPI 分项", "月", "MONTHLY", "指数"),
  cpiFredRow("CUSR0000SEFV", "CPI 外出就餐", "CPI 分项", "月", "MONTHLY", "指数"),
  cpiFredRow("CUSR0000SACE", "CPI 能源商品", "CPI 分项", "月", "MONTHLY", "指数"),
  cpiFredRow("CUSR0000SETB01", "CPI 汽油（全部类型）", "CPI 分项", "月", "MONTHLY", "指数"),
  cpiFredRow("CUSR0000SEHE", "CPI 燃油及其他燃料", "CPI 分项", "月", "MONTHLY", "指数"),
  cpiFredRow("CUSR0000SEHF", "CPI 能源服务", "CPI 分项", "月", "MONTHLY", "指数"),
  cpiFredRow("CUSR0000SEHF01", "CPI 电力", "CPI 分项", "月", "MONTHLY", "指数"),
  cpiFredRow("CUSR0000SEHF02", "CPI 管道燃气服务", "CPI 分项", "月", "MONTHLY", "指数"),
  cpiFredRow("CPIAPPSL", "CPI 服装", "CPI 分项", "月", "MONTHLY", "指数"),
