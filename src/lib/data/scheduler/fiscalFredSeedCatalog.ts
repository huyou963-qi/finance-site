...
export const FISCAL_FRED_SERIES: readonly FiscalFredSeedRow[] = [
  ...
  fiscalFredRow(
    ...
    "百万美元",
    "Treasury/FRED",
    "Gross Federal Debt（Total Public Debt）",
  ),
  fiscalFredRow(
    "FYGFDPUN",
    "公众持有联邦债务",
    "us-federal-debt-public-held",
    "季",
    "QUARTERLY",
    "百万美元",
    "Treasury/FRED",
