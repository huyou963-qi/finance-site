...
export const TREASURY_FISCAL_SERIES: readonly TreasuryFiscalSeedRow[] = [
  ...
  rowFromKey(
    "us-federal-debt-total-daily",
    "treasury_debt_penny_total_daily",
    "debt:penny_total_daily",
    "公共债务总额（日）",
    "日",
    "DAILY",
    "美元",
    "Treasury Debt to the Penny：每日公共债务总额，面值口径",
  ),
  rowFromKey(
    "us-federal-debt-held-public-daily",
    "treasury_debt_penny_held_public_daily",
    "debt:penny_held_public_daily",
    "公众持有联邦债务（日）",
    "日",
    "DAILY",
    "美元",
    "Treasury Debt to the Penny：每日公众持有债务，面值口径",
  ),
  rowFromKey(
